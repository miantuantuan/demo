...
function pathInit ({
  ...
  const value = util.storage.get(currentPath).value()
...
export default {
  ...
  actions: {
    ...
    database (context, {
      ...
      return new Promise(resolve => {
        resolve(util.storage.get(pathInit({
          dbName: 'database',
          path: '',
          user,
          defaultValue: {}
    ...
    pageGet (context, {
      ...
      return new Promise(resolve => {
        resolve(cloneDeep(util.storage.get(pathInit({
          dbName: 'database',
          path: `$page.${vm.$route[basis]}.$data`,
          user,
          defaultValue: cloneDeep(vm.$data)
