...
/******/ 	return __webpack_require__(__webpack_require__.s = "./demo/main.yplayer");
/******/ })
/************************************************************************/
/******/ ({
...
// CONCATENATED MODULE: ./demo/demo-utils.yplayer
...
// CONCATENATED MODULE: ./demo/main.yplayer
...
var testStreams = __webpack_require__(/*! ../tests/test-streams */ "./tests/test-streams.yplayer");
...
$(document).ready(function () {
  ...
  $('h2').append('&nbsp;<a target=_blank href=https://github.com/video-dev/hls.yplayer/releases/tag/v' + Hls.version + '>v' + Hls.version + '</a>');
...
function loadSelectedStream() {
  ...
  onDemoConfigChanged();
  console.log('Using Hls.yplayer config:', hlsConfig);
...
module.exports = {
  ...
  issue666: {
    ...
    'description': 'hls.yplayer/issues/666',
    'live': false,
    'abr': false,
    'blacklist_ua': ['internet explorer']
  },
  ...
  issue649: {
    ...
    'description': 'hls.yplayer/issues/649',
    'live': false,
    'abr': false
  },
  */
...
//# sourceMappingURL=hls-demo.yplayer.map
